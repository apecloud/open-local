...
// This code was taken from https://github.com/openebs/maya/blob/bd98908028af/pkg/hostpath/v1alpha1/hostpath.go
...
func (b *Builder) Validate() error {
	...
	if len(failedValidations) > 0 {
		return fmt.Errorf("host path validation failed: %v", failedValidations)
	}
	return nil
}
